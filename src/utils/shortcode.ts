...
// 默认字符集剔除易混淆字符：0/O/1/I/l
const DEFAULT_ALPHABET = '23456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnpqrstuvwxyz';
const FULL_ALPHABET = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789';
...
export function isValidShortCode(code: string): boolean {
  return new RegExp(`^[A-Za-z0-9]{${DEFAULT_SHORT_CODE_LENGTH}}$`).test(code);
}
